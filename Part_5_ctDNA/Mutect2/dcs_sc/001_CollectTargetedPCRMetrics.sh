...
ln -s /cluster/projects/kridelgroup/RAP_ANALYSIS/ANALYSIS/ConsensusCruncher/consensus_output/consensus/$sample /cluster/projects/kridelgroup/RAP_ANALYSIS/ANALYSIS/ConsensusCruncher/Mutect2/processing/$name.dcs.sc.bam
cd /cluster/projects/kridelgroup/RAP_ANALYSIS/ANALYSIS/ConsensusCruncher/Mutect2/processing
sample=$name.dcs.sc.bam #linked bam file that we can use
...
gatk BedToIntervalList \
      ...
      -O /cluster/projects/kridelgroup/RAP_ANALYSIS/ANALYSIS/ConsensusCruncher/Mutect2/processing/${name}.dcs.sc_amplicon.interval_list \
      -SD $sample

gatk BedToIntervalList \
      -I $targets_interval_list \
      -O /cluster/projects/kridelgroup/RAP_ANALYSIS/ANALYSIS/ConsensusCruncher/Mutect2/processing/${name}.dcs.sc_targets.interval_list \
      -SD $sample

#save new interval lists as variables which will be used as input for final picard function
amps=/cluster/projects/kridelgroup/RAP_ANALYSIS/ANALYSIS/ConsensusCruncher/Mutect2/processing/${name}.dcs.sc_amplicon.interval_list
ints=/cluster/projects/kridelgroup/RAP_ANALYSIS/ANALYSIS/ConsensusCruncher/Mutect2/processing/${name}.dcs.sc_targets.interval_list

gatk CollectTargetedPcrMetrics \
       -I $sample \
       -O ${out_folder}/${name}.dcs.sc.output_pcr_metrics.txt \
       -R $fasta_file \
       --PER_TARGET_COVERAGE ${out_folder}/${name}.dcs.sc.per_target_coverage.txt \
