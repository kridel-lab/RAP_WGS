...
get_mapscape_patient_3 = function(patient){
  ...
  samps$x = c(645, 371, 558, 470, 410, 549, 454, 361, 456, 557, 556, 380, 431, 547, 459, 451, 533, 550, 389, 620)
  samps$y = c(455, 318, 386, 877, 879, 956, 839, 900, 487, 827, 860, 231, 753, 720, 949, 691, 793, 540, 296, 488)
  samps = as.data.frame(samps)
  samps$sample_id = samps$location_id
  colnames(samps) = c("sample_id", "location_id", "x", "y")
