...
# Run Pairtree.
$PTDIR/bin/pairtree --params $input_files/p001_input.params.json $input_files/p001_ssm_input.ssm p001.results.npz --seed 123 --trees-per-chain 4000 --burnin 0.2 --thinned-frac 0.1
...
# Run Pairtree.
$PTDIR/bin/pairtree --params $input_files/p002_input.params.json $input_files/p002_ssm_input.ssm p002.results.npz --seed 123 --trees-per-chain 4000 --burnin 0.2 --thinned-frac 0.1
# Plot best tree results in an HTML file.
...
# Run Pairtree.
$PTDIR/bin/pairtree --params $input_files/p003_input.params.json $input_files/p003_ssm_input.ssm p003.results.npz --seed 123 --trees-per-chain 4000 --burnin 0.2 --thinned-frac 0.1
