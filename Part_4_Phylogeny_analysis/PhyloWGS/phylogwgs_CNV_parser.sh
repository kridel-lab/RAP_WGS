...
#pwd
#/cluster/projects/kridelgroup/RAP_ANALYSIS/results/titan/hmm/optimalClusterSolution

#find -L . -name "*.segs.txt" > cnv_parse_jobs #20

#pwd
names=($(cat cnv_parse_jobs))
echo ${names[${SLURM_ARRAY_TASK_ID}]}

purs=($(cat phylogwgs_CNV_parser_purities.txt))
