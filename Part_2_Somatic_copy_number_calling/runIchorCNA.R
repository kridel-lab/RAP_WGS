...
#edited by KI on July 23, 2019 --> added seqinfo output since no internet connection
...
#saveRDS(seqinfo, "/cluster/home/kisaev/seqinfo_ichorCNA_titan.rds")
