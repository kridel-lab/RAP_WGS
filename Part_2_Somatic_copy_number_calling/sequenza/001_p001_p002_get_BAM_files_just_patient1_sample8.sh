...
MYVAR=LY_RAP_0001_Aut_FzT_08_files/gatk/LY_RAP_0001_Aut_FzT_08.sorted.dup.recal.cram
tum_loc=${MYVAR%/*}
MYVAR=${MYVAR##*/}
...
#sample CRAM file
bam_file=LY_RAP_0001_Aut_FzT_08_files/gatk/LY_RAP_0001_Aut_FzT_08.sorted.dup.recal.cram
