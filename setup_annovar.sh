...
#find -L . -name "*final_selected_variants.vcf.gz" > annovar_jobs #20
...
table_annovar.pl --buildver hg19 ${names[${SLURM_ARRAY_TASK_ID}]} /cluster/tools/software/annovar/humandb --protocol ensGene,gnomad211_genome,cosmic68,avsnp142 --operation g,f,f,f --nastring . --outfile ${names[${SLURM_ARRAY_TASK_ID}]}_annovar.vcf.gz --vcfinput
