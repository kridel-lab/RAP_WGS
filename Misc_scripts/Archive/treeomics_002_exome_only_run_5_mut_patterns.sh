...
#RUN
python treeomics -d input/STRELKA_VCF_INPUTS -n $normal \
--include `cat treeomics_samples_include.txt` \
--purities `cat treeomics_samples_purities.txt` \
-l 5 -f 0.1 --wes_filtering -o /cluster/projects/kridelgroup/RAP_ANALYSIS/ANALYSIS/Treeomics/Treeomics_WES_wpurities
