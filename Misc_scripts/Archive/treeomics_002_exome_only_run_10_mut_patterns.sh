...
#RUN
python treeomics -d input/STRELKA_VCF_INPUTS -n $normal -l 10 -f 0.1 --wes_filtering -o /cluster/projects/kridelgroup/RAP_ANALYSIS/ANALYSIS/Treeomics/Treeomics_WES
