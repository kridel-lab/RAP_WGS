...
samtools view -b -T human_g1k_v37_decoy.fasta -o ${names[${SLURM_ARRAY_TASK_ID}]}.bam ${names[${SLURM_ARRAY_TASK_ID}]}
samtools index ${names[${SLURM_ARRAY_TASK_ID}]}.bam ${names[${SLURM_ARRAY_TASK_ID}]}.bam.bai
