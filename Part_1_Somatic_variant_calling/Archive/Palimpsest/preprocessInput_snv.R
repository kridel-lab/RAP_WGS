...
datadir <- "/cluster/home/kisaev/Palimpsest/RUNNING_PALIMPSEST_EXAMPLE/LiC1162/" # Path to directory containing data files
...
load("/cluster/home/kisaev/Palimpsest/data/ensgene_hg19.RData") # Ensembl genes table (ensgene)
load("/cluster/home/kisaev/Palimpsest/data/cytoband_hg19.RData") # cytoband table (cyto)
