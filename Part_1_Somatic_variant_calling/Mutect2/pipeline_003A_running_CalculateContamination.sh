...
gatk CalculateContamination \
  -I /cluster/projects/burst2/MUTECT2_pileup/${tum}_${chr}.pileups.table \
  -matched /cluster/projects/burst2/MUTECT2_pileup/${patient_name}_${chr}.pileups.table \
  -O ${output}/${tum}_${chr}_contamination.table
