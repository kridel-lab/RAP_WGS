...
#ls */*/*/somatic.snvs.vcf.gz > strelka_default_output
...
tum_name=${MYVAR%/results/variants/somatic.snvs.vcf.gz*}
...
gatk SelectVariants \
   ...
   -O strelka_filtered/${patient_name}_strelka_selectvariants.vcf.gz \
   --exclude-filtered true \
   --select-type-to-exclude INDEL\
   --exclude-intervals Y \

#normalize file
input_vcf=strelka_filtered/${patient_name}_strelka_selectvariants.vcf.gz
